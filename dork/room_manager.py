...
def assembling_rooms(names, neighbors, doors, items):
    ...
    Parameters:
        names(list): A list that contains all the rooms that available in the game map
        neighbors(list): A list that contains all the neighbors of a room 
        doors(list): A list that contains all the doors of a room
        items(list):  A list that contains all the items that are in a room     
    """
...
def move(cardinal, name):
    ...
    Returns:
        current_room_name: Return the current room of the player after the player moves a ertain direction
...
def open_door(room_name, cardinal, key):
    ...
    Returns:
        dict: Return the room with the door opened when there is a matching key to the closed door. 
...
def __description_yaml_representation():
    ...
    Returns:
        descrip_repr(dict): Returns dictionary that contains all the descriptions of rooms
    """
...
def map_yaml_representation():
    ...
    Returns:
        map_representation(dict): Returns dictionary that contains all the rooms with the description
    """
    map_representation = {}
